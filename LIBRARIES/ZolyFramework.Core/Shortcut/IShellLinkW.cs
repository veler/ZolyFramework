// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IShellLinkW.cs" company="Etienne BAUDOUX">
//   
// </copyright>
// <summary>
//   Defines the IShellLinkW type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace ZolyFramework.Core.Shortcut
{
    ...
    [ComImport, Guid(ShellIidGuid.ShellLinkW), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
